...
;(function(win,$){
	...
	// 生成页码
	function fnPager(me, num, index) {
		var par = me.opts.ul.parent();
		var pager = '';
	...
	function fnPagerCallback(me, index) {
		var that = me.opts.ul.parent().find('.pager');
		that.children().eq(index).addClass('active').siblings().removeClass('active');
	}
